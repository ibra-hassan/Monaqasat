        ...
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'target_number', name: 'target_number'},
                    {data: 'directorate_name', name: 'directorate.name'},
                    {data: 'cost_primary', name: 'cost_primary'},
                    {data: 'type_title', name: 'type.title'},
                    {data: 'nature_title', name: 'nature.title'},
