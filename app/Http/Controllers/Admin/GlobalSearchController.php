...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'Governor'       => 'cruds.governor.title',
        'Department'     => 'cruds.department.title',
        'Directorate'    => 'cruds.directorate.title',
        'Office'         => 'cruds.office.title',
        'GovernorAgent'  => 'cruds.governorAgent.title',
        'GeneralManager' => 'cruds.generalManager.title',
        //        'Project'        => 'cruds.project.title',
        'ProjectType'    => 'cruds.projectType.title',
        'ProjectNature'  => 'cruds.projectNature.title',
        'FinancialYear'  => 'cruds.financialYear.title',
    ];
    ...
    public function search(Request $request)
    {
        ...
        foreach ($this->models as $model => $translation) {
            ...
            foreach ($results as $result) {
                ...
                $parsedData['url'] =
                    url('/admin/' . Str::plural(Str::snake($model, '-')) . '/' . $result->id . '/edit');
